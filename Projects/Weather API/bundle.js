...
function resetHTML() {
  ...
  tempC.innerHTML = "Null";
  tempF.innerHTML = "Null";
  isDay.innerHTML = "Null";
  condition.innerHTML = "Null";
  lastUpdated.innerHTML = "Null";
  windMph.innerHTML = "Null";
  windKph.innerHTML = "Null";
  windDirection.innerHTML = "Null";
}

// FUNCTION

const weatherAPI = async function(city) {
    key = "53f4f9ef00b64b37" + "a2690119221807";
    const options = {
        method: 'GET',
        url: `https://api.weatherapi.com/v1/current.json?key=${key}&q=${city}&aqi=yes`
      };
      
    const response = await axios.request(options);
    responseData = response.data;
    cityNameR = responseData.location.name;
    regionR = responseData.location.region;
    countryR = responseData.location.country;
    localTimeR = responseData.location.localtime;
    LtimeDate = localTimeR.slice(0,10);
    LtimeTime = localTimeR.slice(11,16);
    localTimeR = LtimeDate + "&nbsp;&nbsp;&nbsp;" + LtimeTime;
    tempCR = responseData.current.temp_c;
    tempFR = responseData.current.temp_f;
    isDayR = responseData.current.is_day;
    if (isDayR == 0) {
      isDayR = "False";
    } else {
      isDayR = "True";
    }
    conditionR = responseData.current.condition.text;
    lastUpdatedR = responseData.current.last_updated;
    timeDate = lastUpdatedR.slice(0,10);
    timeTime = lastUpdatedR.slice(11,16);
    lastUpdatedR = timeDate + "&nbsp;&nbsp;&nbsp;" + timeTime;
    windMphR = responseData.current.wind_mph;
    windKphR = responseData.current.wind_kph;
    windDirectionR = responseData.current.wind_dir;
    if (windDirectionR == "N") {
    windDirectionR = "North";
    } else if (windDirectionR == "NNE") {
    windDirectionR = "North North East";
    } else if (windDirectionR == "NE") {
    windDirectionR = "North East";
    } else if (windDirectionR == "ENE") {
    windDirectionR = "East North East";
    } else if (windDirectionR == "E") {
    windDirectionR = "East";
    } else if (windDirectionR == "ESE") {
    windDirectionR = "East South East";
    } else if (windDirectionR == "SE") {
    windDirectionR = "South East";
    } else if (windDirectionR == "SSE") {
    windDirectionR = "South South East";
    } else if (windDirectionR == "S") {
    windDirectionR = "South";
    } else if (windDirectionR == "SSW") {
    windDirectionR = "South South West";
    } else if (windDirectionR == "SW") {
    windDirectionR = "South West";
    } else if (windDirectionR == "WSW") {
    windDirectionR = "West South West";
    } else if (windDirectionR == "W") {
    windDirectionR = "West";
    } else if (windDirectionR == "WNW") {
    windDirectionR = "West North West";
    } else if (windDirectionR == "NW") {
    windDirectionR = "North West";
    } else if (windDirectionR == "NNW") {
    windDirectionR = "North North West";
    }
    ...
    console.log(tempFR);
    console.log(isDayR);
    console.log(conditionR);
    console.log(lastUpdatedR);
    console.log(windMphR);
    console.log(windKphR);
    console.log(windDirectionR);

    // DOCUMENT 
    cityName.innerHTML = cityNameR;
    region.innerHTML = regionR;
    country.innerHTML = countryR;
    localTime.innerHTML = localTimeR;
    tempC.innerHTML = tempCR;
    tempF.innerHTML = tempFR;
    isDay.innerHTML = isDayR;
    condition.innerHTML = conditionR;
    lastUpdated.innerHTML = lastUpdatedR;
    windMph.innerHTML = windMphR;
    windKph.innerHTML = windKphR;
    windDirection.innerHTML = windDirectionR;
}
